...
-- customers
CREATE USER customer1 IDENTIFIED BY Pwd_123456_pwd;
CREATE USER customer2 IDENTIFIED BY Pwd_123456_pwd;
CREATE USER customer3 IDENTIFIED BY Pwd_123456_pwd;
